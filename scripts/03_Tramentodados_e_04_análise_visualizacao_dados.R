...
texto_md <-
  #explicação da definição do teto:
"A inspeção da distribuição salarial indicou a presença de valores 
extremamente elevados concentrados exclusivamente no ano de 2022. 
Nesse ano, aproximadamente 9.129 vínculos apresentaram remuneração 
média anual superior a R$ 200.000, com valores máximos próximos 
a R$ 3 milhões. Nos demais anos da série analisada (2019, 2020, 2021 e 2023),
os valores máximos observados situaram-se abaixo de 
R$ 200.000 — respectivamente, cerca de R$ 149 mil, 
R$ 155 mil, R$ 164 mil e R$ 196 mil — não havendo 
registros acima desse patamar. Diante disso, 
optou-se por aplicar um teto absoluto de R$ 200.000
à remuneração média, de modo a mitigar a influência 
de valores extremos e preservar a comparabilidade intertemporal
das estatísticas salariais. Adicionalmente, a mediana salarial
foi utilizada como medida robusta de tendência central."
